...
const aboutData = {
    ...
    ko: {
        ...
        mission: {
            title: "서비스 목표",
            content: "Language Study Master는 오픽(OPIc), 토스(토익 스피킹), 토익, 영어 회화 등 각종 스피킹 어학 시험을 준비하는 독학러들이 말하기 연습을 더 효과적으로 할 수 있도록 돕기 위해 개발되었습니다. YouTube 학습 자료와 직관적인 음성 녹음 기능을 결합하여, 영상을 보면서 즉시 녹음하고 자신의 발음을 들어볼 수 있는 최적의 환경을 제공합니다."
        },
        features: {
            title: "주요 기능",
            list: [
                "YouTube 연동: 오픽/토스 모의고사 영상을 바로 시청하며 연습",
                "음성 녹음: 실전 답변을 실시간으로 녹음",
                "즉시 재생: 자신의 발음, 억양, 속도를 즉시 확인",
                "파일 저장: 녹음본을 WAV 파일로 다운로드하여 소장 및 복습"
            ]
        },
        usage: {
            title: "📖 사용 방법",
